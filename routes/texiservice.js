...
var local = require ('node-localstorage');
...
router.get('/', function(req, res) {
  ...
  console.log("USERID FROM SERVICE:"+req.body.uid)
  ...
  ejs.renderFile('./views/contact.ejs',{data:req.query.No},function(err,result){
    ...
    console.log("req.query.local:"+req.query.local)
    ...
    if (req.query.direct != "T"){
        console.log("req.query.uid:"+req.body.uid)
    var user_details = {
        "Id": "jay12",
        "Accounts":{
                "Type": "Uber",
    ...
    axios.post('http://18.218.112.93:3001/updateUserData',user_details)
        .then(function(response){
            ...
            axios.post('http://18.218.112.93:3001/getUserData',payload)
                .then(function(response){
                    console.log("response.data"+response.data)
                    ejs.renderFile('./views/contact.ejs',{data:req.query.No,details:response.data},function(err,result){
                    if (!err) {
    ...
    axios.post('http://18.218.112.93:3001/updateRides',payload)
                .then(function(response){
                    console.log("response.data"+response.data)
